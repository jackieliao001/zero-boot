...
import com.fast.system.dao.SysRoleDataScopeDao;
import com.fast.system.entity.SysRoleDataScopeEntity;
import com.fast.system.service.SysRoleDataScopeService;
...
public class SysRoleDataScopeServiceImpl extends BaseServiceImpl<SysRoleDataScopeDao, SysRoleDataScopeEntity> implements SysRoleDataScopeService {
    ...
    public void deleteByRoleIdList(List<Long> roleIdList) {
        remove(lambdaQuery().in(SysRoleDataScopeEntity::getRoleId,roleIdList));
    }
}