...
import com.fast.framework.common.utils.AddressUtils;
import com.fast.framework.common.utils.HttpContextUtils;
import com.fast.framework.common.utils.IpUtils;
import com.fast.framework.mybatis.service.impl.BaseServiceImpl;
import com.fast.system.convert.SysLogLoginConvert;
import com.fast.system.dao.SysLogLoginDao;
...
public class SysLogLoginServiceImpl extends BaseServiceImpl<SysLogLoginDao, SysLogLoginEntity> implements SysLogLoginService {
    ...
    public void export() {
        ...
        // 写到浏览器打开
        // ExcelUtils.excelExport(SysLogLoginVO.class, "system_login_log_excel" + DateUtil.now(), null, sysLogLoginVOS);
    }
